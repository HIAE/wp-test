 ...
 * @package WordPress
 * @subpackage twentynineteen-child
 * @since 1.0.0
 */
...
final class WPSScpt{
	...
	public function wpss_cpt_labels() {
		$labels = array(
			...
			'featured_image'        => __( 'Breed Image', 'wpss' ),
			'set_featured_image'    => __( 'Set breed image', 'wpss' ),
			'remove_featured_image' => __( 'Remove breed image', 'wpss' ),
			'use_featured_image'    => __( 'Use as breed image', 'wpss' ),
